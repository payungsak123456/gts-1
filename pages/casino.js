...
export default function Casino() {
  return (
    <>
      <NextSeo
        title="GTS GOLD 168 - ฝากถอนโอนไว"
      ...
      <Head>
        ...
        <title> GTS 168 - ฝากถอนโอนไว</title>
        {/* <!-- favicon --> */}
        <link
          rel="shortcut icon"
          ...
          <div className="hero-area">
                ...
                <div style={{ paddingTop: "5%" }}>
                  <div className="container">
                    ...
                    <ul>
                      <ol>
                        <b style={{ color: "pink" }}>*</b> &nbsp; &nbsp;
                        ตัดยอดเป็นรายสัปดาห์ จ่ายตามยอดเสียทั้งหมด
                        ของลูกค้าของคุณ
                      </ol>

                      <ol>
                        <b style={{ color: "pink" }}>*</b> &nbsp; &nbsp;
                        ท่านจะได้ถือหุ้นกับเรา และ จะแบ่งเป็น แทงบอล
                        ได้รับสูงสุด 80% / คาสิโน ได้รับสูงสุด 75%
                      </ol>

                      <ol>
                        <b style={{ color: "pink" }}>*</b> &nbsp; &nbsp;
                        บริษัทขอสงวนลิขสิทธิ์ ในการเปลี่ยนแปลงข้อมูล
                        โดยจะต้องมีการแจ้งให้ทางบริษัททราบล่วงหน้าอย่างน้อย 30
                        วัน
                      </ol>
            ...
            <div className="container">
              <b style={{ fontSize: "18px" }}>
                ...
                ก็จะได้รับยอดสูงเช่นกัน และ
                หากเอเย่นต์ที่มีฐานลูกค้าเยอะอยู่แล้ว
